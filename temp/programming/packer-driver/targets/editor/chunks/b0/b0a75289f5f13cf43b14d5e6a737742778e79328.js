System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, RichText, color, sys, assetManager, TextAsset, AudioManager, CommonTS, Constant, TypeActionForecast, Languages, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, PrefabForecastMonth;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Label', 'Sprite', 'RichText', 'SpriteFrame', 'color', 'sys', 'assetManager', 'TextAsset', 'native']);
        ...
        loadData(url) {
          ...
          if (bundle == null) {
            assetManager.loadBundle("data", (err, bundle) => {
              let richText = this.richTextMonth;
              bundle.loadDir(url, TextAsset, function (err, texture) {
                richText.string = `<color=#00ff00>${texture.toString()}</color>`;
              });
            });
          } else {
            let richText = this.richTextMonth;
...
//# sourceMappingURL=b0a75289f5f13cf43b14d5e6a737742778e79328.js.map