System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Sprite, RichText, SpriteFrame, Prefab, instantiate, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, PrefabForecast;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PrefabForecast", PrefabForecast = (_dec = ccclass('PrefabForecast'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Sprite), _dec5 = property(RichText), _dec6 = property(Sprite), _dec7 = property(SpriteFrame), _dec8 = property(SpriteFrame), _dec9 = property(Node), _dec10 = property(Prefab), _dec(_class = (_class2 = class PrefabForecast extends Component {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "icSun", _descriptor6, this);

          _initializerDefineProperty(this, "icMoon", _descriptor7, this);

          this.isShowPrefabMonth = false;

          _initializerDefineProperty(this, "nodeParentForecast", _descriptor8, this);

          _initializerDefineProperty(this, "prefabForecastMonth", _descriptor9, this);
        }
        ...
        showNodeMonth() {
          ...
          nodeMonth.name = "monthForecast"; // this.nodeParentForecast.addChild(nodeMonth)
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "icSun", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "icMoon", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "nodeParentForecast", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "prefabForecastMonth", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=bf0c53aad08eadfac5e27c4cdc1866ef20a5181a.js.map