System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Label, Sprite, sys, native, Button, SpriteFrame, AudioManager, Languages, i18n, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, Settings;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Settings", Settings = (_dec = ccclass("Settings"), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Sprite), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(SpriteFrame), _dec10 = property(SpriteFrame), _dec(_class = (_class2 = class Settings extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "icOFF", _descriptor9, this);
        }
        ...
        updateLayoutMusic() {
          this.btnOnOffMusic.getComponent(Sprite).spriteFrame = (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).getMusic() === "true" ? this.icON : this.icOFF;
        }

        updateLayoutSound() {
          this.btnOnOffSound.getComponent(Sprite).spriteFrame = (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).getSound() === "true" ? this.icON : this.icOFF;
        }
        ...
        loadVersionTitle() {
          ...
          if (sys.os == sys.OS.ANDROID) {
            ...
            var methodName = "loadVersionName";
        ...
        showFeedback() {
          ...
          if (sys.os == sys.OS.ANDROID) {
            var className = "org/cocos2dx/javascript/AppActivity";
            var methodName = "sendMailWithSubject";
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "icOFF", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=989a7cc514bc9757a627189bc3927dda5310b4ca.js.map