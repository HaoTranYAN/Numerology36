System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Label, Sprite, sys, AudioManager, Languages, i18n, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, Settings;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'director', 'Label', 'Sprite', 'sys']);
      ...
      _export("Settings", Settings = (_dec = ccclass("Settings"), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Sprite), _dec5 = property(Label), _dec(_class = (_class2 = class Settings extends Component {
        ...
        showFeedback() {
          if (sys.os == sys.OS.ANDROID) {
            ...
            jsb.reflection.callStaticMethod(className, methodName, methodSignature, "Numerology Android Feedback", "apps@yan.vn");
          } else if (sys.os == sys.OS.IOS) {
            var ret = jsb.reflection.callStaticMethod("AppController", "sendMailWithSubject:andMail:", "Numerology iOS Feedback", "apps@yan.vn");
          }
        }
        ...
        shareApp() {
          ...
          if (sys.os == sys.OS.ANDROID) {
            ...
            var ret = jsb.reflection.callStaticMethod("AppController", "shareApp:", "");
          } // //  }
          // //  else {
...
//# sourceMappingURL=8511fbf511faa1c51c9d797a90f094f1d9431fa2.js.map