System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, EditBox, ToggleComponent, AudioManager, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, Profile;
      ...
      _export("default", Profile = (_dec = ccclass('Profile'), _dec2 = property(ToggleComponent), _dec3 = property(ToggleComponent), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(EditBox), _dec7 = property(EditBox), _dec8 = property(EditBox), _dec9 = property(EditBox), _dec10 = property(Label), _dec(_class = (_class2 = class Profile extends Component {
        ...
        validateInfo() {
          ...
          if (d == "") {
            ...
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR8");
            return;
          } else if (y == "") {
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR9");
            return;
          } else if (name == "") {
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR10");
            return;
          } else if (this.checkFormat(d) != -1) {
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR4");
            return;
          } else if (this.checkFormat(m) != -1) {
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR11");
            return;
          } else if (this.checkFormat(y) != -1) {
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR12");
            return;
          }
          ...
          if (day <= 0 || month <= 0) {
            this.noticeLabel.node.active = true;
            this.noticeLabel.string = i18n.t("ERROR3");
            return;
          }
        }
...
//# sourceMappingURL=685c200a0af0f86b003164c09deaec090621bc0f.js.map