System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Button, Sprite, RichText, EditBox, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, PhoneAddess;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Button', 'Sprite', 'RichText', 'EditBox']);
      ...
      _export("PhoneAddess", PhoneAddess = (_dec = ccclass('PhoneAddess'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(RichText), _dec7 = property(EditBox), _dec(_class = (_class2 = class PhoneAddess extends Component {
        constructor() {
          super(...arguments);
...
//# sourceMappingURL=1071bf784c0011630f55f98cd7f3c370b3486048.js.map