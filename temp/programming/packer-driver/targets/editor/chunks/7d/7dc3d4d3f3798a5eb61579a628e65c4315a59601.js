          ...
          if (bundle == null) {
            assetManager.loadBundle("data", (err, bundle) => {
              ...
              bundle.loadDir(url, TextAsset, function (err, texture) {
                ...
                self.richTextDay.string = "Hôm nay là một ngày may mắn dành cho bạn. Nếu bạn nhận được lời mời từ ai đó thì đừng nên ngần ngại mà hãy thoải mái đón nhận nó. Bởi vì đây là khoảng thời gian thích hợp để bạn dành nhiều thời gian hơn cho bạn bè và gia đình, người thân hoặc các mối quan hệ bạn quan tâm.";
              });
            });
          } else {
...
//# sourceMappingURL=7dc3d4d3f3798a5eb61579a628e65c4315a59601.js.map