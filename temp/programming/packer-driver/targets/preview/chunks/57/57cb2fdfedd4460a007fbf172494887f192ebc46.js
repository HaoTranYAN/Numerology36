System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, RichText, Label, Prefab, ScrollView, director, sys, instantiate, AudioManager, Languages, i18n, Constant, TypeAction, CommonTS, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _crd, ccclass, property, Detail;
      ...
      _export("Detail", Detail = (_dec = ccclass('Detail'), _dec2 = property(RichText), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Prefab), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(ScrollView), _dec10 = property(Node), _dec11 = property(Prefab), _dec12 = property(Prefab), _dec(_class = (_class2 = class Detail extends Component {
        ...
        loadData(soChuDao, soDuongDoi, namCaNhan, period, indexByName, nameDestiny) {
          ...
          switch (window["typeAction"]) {
            ...
            case 3:
              // code block
              number = indexByName.impressionNumber;
              this.lblTitle.string = i18n.t("EXPRESSIONNUMBER");
              break;
            ...
            case 8:
              number = period.gd1;
              this.titleLabel.string = i18n.t("PERIOD1");
              break;
          ...
          this.titleLabel.string = this.titleLabel.string.toLocaleUpperCase();
          this.addPrefab(number, typeNumber);
        }
        ...
        loadDataKarmic(karmicDebt) {
          ...
          if (len == 0) {
            this.addYoursNumber("0");
          } else {
            this.addYoursNumber(karmicDebt.toString().replace(/,/g, ", "));

            for (var i = 0; i < len; i++) {
              this.addPrefab(karmicDebt[i], (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
                error: Error()
              }), TypeAction) : TypeAction).KARMIC_DEBT);
            }
          }
        ...
        addPrefab(dataNumber, typeNumber) {
          var nodeText = instantiate(this.prefabCountNumber);
          nodeText.name = "nodeCount";
        ...
        addYoursNumber(str) {
          ...
          var cell = nodeText.getComponent("YourNumbers");
...
//# sourceMappingURL=57cb2fdfedd4460a007fbf172494887f192ebc46.js.map