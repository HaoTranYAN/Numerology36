System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, director, sys, Prefab, instantiate, AudioManager, Constant, TypeAction, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _crd, ccclass, property, Home;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Home", Home = (_dec = ccclass('Home'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(Prefab), _dec(_class = (_class2 = class Home extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "prefabForecast", _descriptor8, this);
        }
        ...
        addPrefab() {
          var nodeForecast = instantiate(this.prefabForecast);
          nodeForecast.name = "nodeForecast";
          this.content.addChild(nodeForecast);
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "prefabForecast", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=500849aebddb1956a8d854d1908a0fd234eed7f2.js.map