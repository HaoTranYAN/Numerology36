  ...
  return {
    ...
    execute: function () {
      ...
      _export("Detail", Detail = (_dec = ccclass('Detail'), _dec2 = property(RichText), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Prefab), _dec7 = property(Prefab), _dec8 = property(Prefab), _dec9 = property(ScrollView), _dec10 = property(Node), _dec11 = property(Prefab), _dec12 = property(Prefab), _dec(_class = (_class2 = class Detail extends Component {
        ...
        addPrefab(dataNumber) {// var nodeText =  instantiate(this.prefabDetailYourNumber);
        ...
        loadDataInfo() {
          switch (window["typeAction"]) {
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGLIFEPATH");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGMASTERNUMBER");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGDESTINY");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGPERSONALYEAR");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGKARMICDEBT");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGPERIOD1");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGPERIOD2");
              break;
            ...
            case (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
              ...
              this.richTextContentInfo.string = i18n.t("MEANINGPERIOD3");
              break;
          }

          this.lblTitleInfo.string = this.lblTitleInfo.string.toUpperCase();
        }
...
//# sourceMappingURL=11312587189d93ec47945684701b9f731fadbc37.js.map