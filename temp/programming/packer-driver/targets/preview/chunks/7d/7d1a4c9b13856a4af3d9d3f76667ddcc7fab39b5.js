System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Sprite, RichText, Prefab, instantiate, color, sys, assetManager, AudioManager, CommonTS, Constant, TypeActionForecast, Languages, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, PrefabForecast;
    ...
    execute: function () {
      ...
      _export("PrefabForecast", PrefabForecast = (_dec = ccclass('PrefabForecast'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(RichText), _dec5 = property(Sprite), _dec6 = property(Node), _dec7 = property(Prefab), _dec(_class = (_class2 = class PrefabForecast extends Component {
        ...
        */
        ...
        loadData(url) {
          var self = this;
          var bundle = assetManager.getBundle("data"); // assetManager.loadBundle("data"+url, TextAsset,function (err, texture){
          //   self.richTextDay.string =`<color=#000000>${texture.toString()}</color>`;
          // } )
          // remote Text

          var remoteUrl = "https://www.w3.org/TR/PNG/iso_8859-1.txt";
          assetManager.loadRemote(remoteUrl, function (err, textAsset) {
            self.richTextDay.string = "<color=#000000>" + textAsset + "</color>";
...
//# sourceMappingURL=7d1a4c9b13856a4af3d9d3f76667ddcc7fab39b5.js.map