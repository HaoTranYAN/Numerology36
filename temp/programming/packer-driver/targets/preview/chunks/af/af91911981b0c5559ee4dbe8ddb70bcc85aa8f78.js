System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", Profile = (_dec = ccclass("Profile"), _dec2 = property(ToggleComponent), _dec3 = property(ToggleComponent), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(EditBox), _dec7 = property(EditBox), _dec8 = property(EditBox), _dec9 = property(EditBox), _dec10 = property(Label), _dec11 = property(Button), _dec(_class = (_class2 = class Profile extends Component {
        constructor() {
          super(...arguments);
        ...
        onLoad() {
          this.lblError.node.active = false; // this.rdFemale.isChecked=true;
        }
        ...
        resetLayout() {
          ...
          this.signOutLabel.node.active = false;
          this.imgGirl.active = false;
          this.imgBoy.active = true;
          this.femaleClicked.active = false;
          this.maleClicked.active = true;
          this.sex = 0;
        }
...
//# sourceMappingURL=af91911981b0c5559ee4dbe8ddb70bcc85aa8f78.js.map