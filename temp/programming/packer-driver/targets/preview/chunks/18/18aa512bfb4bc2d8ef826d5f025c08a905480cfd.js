System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, RichText, color, sys, native, AudioManager, CommonTS, Constant, TypeActionForecast, Languages, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, PrefabForecastMonth;
      ...
      _export("PrefabForecastMonth", PrefabForecastMonth = (_dec = ccclass('PrefabForecastMonth'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(RichText), _dec(_class = (_class2 = class PrefabForecastMonth extends Component {
        ...
        */
        ...
        loadData(url) {
          ...
          //     });
          // }
          this.richTextMonth.string = native.fileUtils.getStringFromFile("data/" + url);
        }
...
//# sourceMappingURL=18aa512bfb4bc2d8ef826d5f025c08a905480cfd.js.map