          ...
          if (bundle == null) {
            assetManager.loadBundle("data", (err, bundle) => {
              ...
              bundle.loadDir(url, TextAsset, function (err, texture) {
                console.log("HAOHAO1: " + texture); //  self.richTextDay.string =`<color=#000000>${texture.toString()}</color>`;

                self.richTextDay.string = texture.toLocaleString();
              });
            });
          } else {
...
//# sourceMappingURL=124a34009d0f1d5f32928ac41c586437061ffc7c.js.map