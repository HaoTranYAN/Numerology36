System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Label, Sprite, sys, native, Button, AudioManager, Languages, i18n, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _crd, ccclass, property, Settings;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Settings", Settings = (_dec = ccclass("Settings"), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Sprite), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec10 = property(Button), _dec(_class = (_class2 = class Settings extends Component {
        constructor() {
          super(...arguments);
        ...
        updateLayoutMusic() {
          if ((_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            ...
            this.btnOffMusic.node.active = false;
            this.btnOnMusic.node.active = true;
          } else {
            this.btnOffMusic.node.active = true;
            this.btnOnMusic.node.active = false;
          }
        }
        ...
        updateLayoutSound() {
          if ((_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            ...
            this.btnOffSound.node.active = false;
            this.btnOnSound.node.active = true;
          } else {
            this.btnOffSound.node.active = true;
            this.btnOnSound.node.active = false;
          }
        }
...
//# sourceMappingURL=7f4ec9ebe6fae07c91313fa3203e9e8372fa43d0.js.map