System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("PhoneAddess", PhoneAddess = (_dec = ccclass("PhoneAddess"), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec6 = property(RichText), _dec7 = property(EditBox), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Prefab), _dec12 = property(Node), _dec13 = property(ScrollView), _dec14 = property(Prefab), _dec(_class = (_class2 = class PhoneAddess extends Component {
        constructor() {
          super(...arguments);
        ...
        checkValidate() {
          ...
          if (window["typeAction"] == (_crd && TypeAction === void 0 ? (_reportPossibleCrUseOfTypeAction({
            ...
            if (mobileEB == "") {
              ...
              var numberMobile = this.tinhNumber(this.edtInput.string);
...
//# sourceMappingURL=cba0a11622c0f306c7ed2988579ad5bb9fcdb83b.js.map