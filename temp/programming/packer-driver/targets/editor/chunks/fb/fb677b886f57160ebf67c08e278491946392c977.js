System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Label, Sprite, RichText, Prefab, instantiate, color, sys, resources, AudioManager, CommonTS, Constant, TypeActionForecast, Languages, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, PrefabForecast;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Label', 'Sprite', 'RichText', 'SpriteFrame', 'Prefab', 'instantiate', 'color', 'sys', 'native', 'resources']);
      ...
      _export("PrefabForecast", PrefabForecast = (_dec = ccclass('PrefabForecast'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(RichText), _dec5 = property(Sprite), _dec6 = property(Node), _dec7 = property(Prefab), _dec(_class = (_class2 = class PrefabForecast extends Component {
        ...
        */
        ...
        loadData(url) {
          ...
          resources.load(url, function (err, file) {
            this.richTextDay.string = file;
          });
        }
...
//# sourceMappingURL=fb677b886f57160ebf67c08e278491946392c977.js.map