    ...
    execute: function () {
      ...
      _export("AudioManager", AudioManager = class AudioManager {
        ...
        static playSound(name) {
          const audioSource = AudioManager._audioSourceSound;
          assert(audioSource, "SoundManager not inited!");
          audioSource.play(); // const audioSource = AudioManager._audioSource!;
          // assert(audioSource, "AudioManager not inited!");
...
//# sourceMappingURL=5b801f139e17427d0aada46b13916646fdb79ee5.js.map